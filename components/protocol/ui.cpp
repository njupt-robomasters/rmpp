...
uint8_t UI::Update() {
    ...
    char ui_buf[30];
    // id 0 shoot freq
    if(set_bullet_frequency!=set_bullet_frequency_last)
    {
    ...
    if(set_is_firing!=set_is_firing_last || set_is_locked!=set_is_locked_last){
        if (set_is_firing) {
    ...
    // id 2 chassis mode
    if(set_gimbal_is_imu_mode!=set_gimbal_is_imu_mode_last){
    ...
    // id 3 chassis_mode
    if(set_chassis_mode!=set_chassis_mode_last)
    {
    ...
    // id 4 chassis_vr
    if(set_chassis_vr!=set_chassis_vr_last)
    {
    ...
    // id 5
    if(set_chassis_max_speed!=set_chassis_max_speed_last)
    {
    ...
    // id 6 7 update
    if(set_center_gain_status!=set_center_gain_status_last)
    {
    ...
    if(set_super_cap_percent!=set_super_cap_percent_last)
    {
    ...
    // id 9 power_limit
    if(set_chassis_power_limit!=set_chassis_power_limit_last)
    {
    ...
    // id 10 摩擦轮电机状态
    if(set_shooter_is_on!=set_shooter_is_on_last)
    {
