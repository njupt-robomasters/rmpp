...
void Chassis_Omni::backward() {
    ...
    // 全向轮速度逆解 begin
    v1 = -sqrt2div2 * vx + sqrt2div2 * vy + vz;
    v2 = -sqrt2div2 * vx - sqrt2div2 * vy + vz;
    v3 = +sqrt2div2 * vx - sqrt2div2 * vy + vz;
    v4 = +sqrt2div2 * vx + sqrt2div2 * vy + vz;
    // 全向轮速度逆解 end
    ...
    // 全向轮力学逆解 begin
    f1 = (-sqrt2 * fx + sqrt2 * fy + fz) / 4.0f;
    f2 = (-sqrt2 * fx - sqrt2 * fy + fz) / 4.0f;
    f3 = (+sqrt2 * fx - sqrt2 * fy + fz) / 4.0f;
    f4 = (+sqrt2 * fx + sqrt2 * fy + fz) / 4.0f;
    // 全向轮力学逆解 end
