...
Chassis::Chassis(PID::param_t* wheel_pid, PID::param_t* servo_pid, PID::param_t* follow_pid) :
    m_wheel1(1, 1),
    m_wheel2(1, 2),
    m_servo1(1, 3),
    m_servo2(1, 4) {
    ...
    m_servo1.SetPID(Motor::ANGLE_MODE, Motor::CURRENT_TYPE, servo_pid);
    m_servo2.SetPID(Motor::ANGLE_MODE, Motor::CURRENT_TYPE, servo_pid);
